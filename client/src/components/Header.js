  ...
  return (
    <>
      <div className={`site-header-small-screen${menu ? "" : " hidden"}`}>
        <nav>
          <ul>
            ...
            <li
              className={location.pathname === "/tools" ? "active-page" : ""}
              onClick={() => setMenu(false)}
            >
              <Link to="/tools">Tools</Link>
            </li>
            <li
              className={location.pathname === "/stations" ? "active-page" : ""}
              onClick={() => setMenu(false)}
            >
      ...
      <header className="site-header">
        ...
        <ul>
          {/* <li className={location.pathname === "/news" ? "active-page" : ""}>
            <Link to="/news">News</Link>
          </li> */}
          <li className={location.pathname === "/tools" ? "active-page" : ""}>
            <Link to="/tools">Tools</Link>
          </li>
          <li
            className={location.pathname === "/stations" ? "active-page" : ""}
